      ...
      {couples.map((couple, idx) => (
        ...
        >
          <div className="pairing-side">
            <Avatar id={couple.partner_a_id} name={couple.partner_a_name} size="sm" look={lookFor(couple.partner_a_id)} />
          ...
          <div className="pairing-side end">
            ...
            <Avatar id={couple.partner_b_id} name={couple.partner_b_name} size="sm" look={lookFor(couple.partner_b_id)} />
          </div>
        </div>
      ))}
      <style jsx>{`
