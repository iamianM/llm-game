...
def test_create_character_assigns_archetype_and_stats() -> None:
    ...
    create_character(state, archetype_id="heartthrob", stats=stats)
...
def test_create_character_applies_heartthrob_advantage() -> None:
    ...
    create_character(state, archetype_id="heartthrob", stats=PlayerStats(charm=9, banter=6, eq=5, graft=5, loyalty=5))
...
def test_create_character_applies_class_clown_advantage() -> None:
    ...
    create_character(state, archetype_id="class_clown", stats=PlayerStats(charm=5, banter=9, eq=6, graft=5, loyalty=5))
...
def test_create_character_applies_loyal_friend_advantage() -> None:
    ...
    create_character(state, archetype_id="loyal_friend", stats=PlayerStats(charm=5, banter=6, eq=5, graft=5, loyalty=9))
